...
export default function TrackHealth() {
  ...
  return (
    <>
      ...
      <div className="bento">
        {/* Track Map */}
        <motion.div className="g-card" style={{ padding: 0, overflow: 'hidden' }} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
        ...
        {/* Alerts + Rolling Stock Predictor */}
        <div className="bento-stack">
          <motion.div className="g-card" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}>
            <div className="g-card-head">
              <div className="g-card-title">⚠️ High-Risk Alerts</div>
            </div>
            <div className="triage-feed" style={{ maxHeight: 180 }}>
              {alertList.length === 0 && <div style={{ padding: 16, textAlign: 'center', color: 'var(--text-muted)', fontSize: 12 }}>No high-risk alerts</div>}
              {alertList.map((a) => (
                <div key={a.segment_id} className="triage-item critical">
          ...
          {/* Rolling Stock Health Mini-Form */}
          ...
          {/* Track Health Predictor Mini-Form */}
          <motion.div className="g-card" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }}>
            <div className="g-card-head">
            ...
            <form onSubmit={handleTrackPredict}>
              ...
              <button className="btn btn-primary btn-sm" type="submit" style={{ width: '100%', marginTop: 8 }}>
